...
const String courseDetailsPath = "courses/";
const String makeCourseReviewPath = "/courses/review/";
...
const String donationsPath = "donations";
const String donationDetailsPath = "donations/";
const String testimonialsPath = "testimonials";
const String testimonialDetailsPath = "testimonials/";
const String sectionsStatusPath = "setting/all/section_status";
const String settingsPath = "settings";
const String sectionsPath = "/sections";
const String aboutSectionPath = "/sections/about";
const String experienceSectionPath = "/sections/experience";
const String whoWeAreSectionPath = "/sections/who_we_are";
const String whyChooseUsSectionPath = "/sections/why_choose_us";
const String solutionsSectionPath = "/sections/solutions";
...
/// themes
const String themesPath = "theams";
const String themeDetailsPath = "theam/";
