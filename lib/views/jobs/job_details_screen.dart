      ...
      body:  Stack(
          children: [
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    width: size.width,
                    padding: const EdgeInsets.only(left: 16.0, top: 56.0, right: 16.0, bottom: 16.0),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            AppText("years_of_experience".tr, fontSize: 14),
                            const SizedBox(width: 10),
                        ...
                        Row(
                          children: [
                            AppText("location".tr, fontSize: 14),
                            const SizedBox(width: 10),
            ...
            Align(alignment: Alignment.bottomCenter, child: Container(
                ...
                child: AppElevatedButton(text: "apply_now".tr, onPressed:()=> Get.to(()=> ApplyJobScreen(jobModel: jobModel)),)),)
          ],
        ),
    );
  }
